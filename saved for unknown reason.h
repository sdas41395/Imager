...
#define  PANEL1_SPLITTER_2                29      /* control type: splitter, callback function: (none) */
#define  PANEL1_STRING_POWER2             30      /* control type: string, callback function: (none) */
#define  PANEL1_STRING_POWER1             31      /* control type: string, callback function: (none) */
#define  PANEL1_COMMANDBUTTON_3           32      /* control type: command, callback function: TurnPowerSupplyOff */
#define  PANEL1_COMMANDBUTTON_4           33      /* control type: command, callback function: ReadPowerSupplyStatus */
#define  PANEL1_RADIOBUTTON_2             34      /* control type: radioButton, callback function: (none) */
#define  PANEL1_RADIOBUTTON               35      /* control type: radioButton, callback function: (none) */
#define  PANEL1_NUM_R                     36      /* control type: numeric, callback function: SetDiodeMult */
#define  PANEL1_NUM_CAL                   37      /* control type: numeric, callback function: SetDiodeMult */
#define  PANEL1_COMMANDBUTTON_2           38      /* control type: command, callback function: Check_Table_Struct_Values */
...
#define  PANEL3_COMMANDBUTTON_2           27      /* control type: command, callback function: ShowAllTimestamps */
...
int  CVICALLBACK ShowAllTimestamps(int panel, int control, int event, void *callbackData, int eventData1, int eventData2);
